 ...
 * COFFEE_CHAIN_V1
 *
 * Frozen platform template for Coffee Chain organizations.
 *
 * The Coffee Chain experience emphasizes repeat visits, membership,
 * rewards/offers and multiple store locations.
 */
export const COFFEE_CHAIN_V1: TemplateDefinition = {
  id: "coffee-chain-v1",
  version: "1.0.0",
  category: "FOOD_AND_BEVERAGE" as TemplateDefinition["category"],
  displayName: "Food & Beverage — Coffee Chain",
  ...
  supportedCardStyles: [CardStyle.MODERN, CardStyle.MINIMAL, CardStyle.CLASSIC],
