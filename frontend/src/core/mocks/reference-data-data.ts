...
export const BENEFIT_CATEGORIES: ReferenceDataItem[] = [
  ...
  {
    id: "benefit-category-tier-upgrade",
    code: "TIER_UPGRADE",
    name: "Tier Upgrade",
    displayOrder: 5,
    active: true,
