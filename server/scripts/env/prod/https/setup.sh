...
"$repo_root/server/scripts/common/backend/linux/install-backend-service.sh" "memgine-prod" "$MEMGINE_APP_USER" "$repo_root" "$script_dir/memgine.env" "$repo_root/server/build/libs/memgine-server.jar"
